...
**Example**
Google Colab allows you to run Jupyter Notebooks without needing to install anything on your computer.
...
## Cases in python condition
A case condition refers to checking multiple possible values of a variable, typically using if-elif-else statements.
